...
(
	...
	HEART_CHECK varchar2(1) CHECK (HEART_CHECK = 'Y' OR HEART_CHECK = 'N') NOT NULL,
	MEMBER_NUMBER number NOT NULL,
	MOVIE_NUMBER number NOT NULL,
...
(
	...
	WATCH_CHECK varchar2(1) CHECK (WATCH_CHECK = 'Y' OR WATCH_CHECK = 'N') NOT NULL,
	MEMBER_NUMBER number NOT NULL,
	MOVIE_NUMBER number NOT NULL,
...
ALTER TABLE BASKET
	...
	REFERENCES MEMBER (MEMBER_NUMBER) ON DELETE CASCADE
;
...
ALTER TABLE BASKET
	...
	REFERENCES MOVIE (MOVIE_NUMBER) ON DELETE CASCADE
;
