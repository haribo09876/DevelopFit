...
VALUE(  MEMBER_NUMBER,
        ...
        MEMBER_CREATE_DATE,
        MEMBER_MODIFY_DATE)
VALUES(MEMBER_NUMBER_SEQ.NEXTVAL, 'aa', 'aa', '김용원', 'kimj92@ezen.com', '1992-01-30', '01014351668', 20000, 'M', SYSDATE, SYSDATE);
INSERT INTO MEMBER
...
VALUES(MOVIE_NUMBER_SEQ.NEXTVAL, '잠', '행복한 신혼부부 ‘현수’(이선균)와 ‘수진’(정유미). 어느 날, 옆에 잠든 남편 ‘현수’가 이상한 말을 중얼거린다.', '2023-09-06', 94, 10000, '<iframe width="1271" height="715" src="https://www.youtube.com/embed/aRxQDCXnfOc" title="[잠] 메인 예고편" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>', '15세 관람가', 'https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230906_145%2F1693965381891wjuK6_JPEG%2Fmovie_image.jpg', 14);
INSERT INTO MOVIE
VALUES(MOVIE_NUMBER_SEQ.NEXTVAL, '콘크리트 유토피아', '“아파트는 주민의 것” 온 세상을 집어삼킨 대지진, 그리고 하루아침에 폐허가 된 서울. 모든 것이 무너졌지만 오직 황궁 아파트만은 그대로다.', '2023-08-09', 130, 10000, '<iframe width="560" height="315" src="https://www.youtube.com/embed/hAO9a1xSo3M?si=QmCb2R7glajd4FGK" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>', '15세 관람가', 'https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230809_114%2F1691559109714F3JPy_JPEG%2Fmovie_image.jpg', 15);
INSERT INTO MOVIE
VALUES(MOVIE_NUMBER_SEQ.NEXTVAL, '엘리멘탈', '불, 물, 공기, 흙 4개의 원소들이 살고 있는 ‘엘리멘트 시티’ 재치 있고 불처럼 열정 넘치는 ‘앰버’', '2023-06-14', 109, 11000, '<iframe width="560" height="315" src="https://www.youtube.com/embed/BOqFRHCrN-k?si=PlibcbCbekEBTlBw" title="YouTube video player" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>', '전체 관람가', 'https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230526_154%2F1685060493223yFUCL_JPEG%2Fmovie_image.jpg', 16);
INSERT INTO MOVIE
VALUES(MOVIE_NUMBER_SEQ.NEXTVAL, '타겟', '중고거래로 범죄의 표적이 된 ‘수현’의 일상 속에서 벌어지는 서스펜스를 담은 스릴러', '2023-08-30', 101, 8000, '<iframe width="1271" height="715" src="https://www.youtube.com/embed/KAALefFwomw" title="[타겟] 메인 예고편" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share" allowfullscreen></iframe>', '12세 관람가', 'https://search.pstatic.net/common?quality=75&direct=true&src=https%3A%2F%2Fmovie-phinf.pstatic.net%2F20230830_155%2F1693380545549R60c7_JPEG%2Fmovie_image.jpg', 15);
SELECT* FROM MOVIE;
...
VALUE(ORDER_HISTORY_NUMBER, ORDER_HISTORY_TIME, MEMBER_NUMBER)
VALUES(ORDER_HISTORY_NUMBER_SEQ.NEXTVAL, SYSDATE, 1);
-- 해당 주문 내역의 상품 정보
INSERT INTO ORDER_PRODUCT
VALUE(ORDER_PRODUCT_NUMBER, ORDER_HISTORY_NUMBER, MOVIE_NUMBER)
VALUES(ORDER_PRODUCT_NUMBER_SEQ.NEXTVAL, ORDER_HISTORY_NUMBER_SEQ.CURRVAL, 4);
INSERT INTO ORDER_PRODUCT
VALUE(ORDER_PRODUCT_NUMBER, ORDER_HISTORY_NUMBER, MOVIE_NUMBER)
VALUES(ORDER_PRODUCT_NUMBER_SEQ.NEXTVAL, ORDER_HISTORY_NUMBER_SEQ.CURRVAL, 2);
