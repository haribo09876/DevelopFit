		...
		<div id="form-wrap">
			<form class="form-login" name="loginForm" action="loginCtr.do"
				...
				<input type="password" name="memberPassword" placeholder="비밀번호"
					id="input-pw" onfocus="this.placeholder=''"
					onblur="this.placeholder='비밀번호'"><br> <input
					type="button" value="로그인" id="input-btn" onclick="check();">

				<div id="signup" onclick="pageMove();">회원가입</div>

				<div id="signup-kakao">카카오로 회원가입</div>
				<br>
