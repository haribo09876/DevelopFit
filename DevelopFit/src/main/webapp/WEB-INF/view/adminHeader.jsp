...
<div id="adminHeader">
	...
	<div id="subMenu">
		<ul>
			...
			<li class="submenu1"><a href="../movie/adminList.do" class="submenu1-1">전체영화</a></li>
			<li class="submenu1"><a href="../board/adminList.do" class="submenu1-1">전체게시물</a></li>
			<li class="submenu2"><a href="../admin/history.do" class="submenu1-1">전체주문내역</a></li>
			<li class="submenu3"><a href="../movie/commentList.do" class="submenu1-1">전체한줄평</a></li>
